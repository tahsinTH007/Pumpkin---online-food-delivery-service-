  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-2">
        ...
        <div className="flex justify-between text-sm">
          <span>Delivery Fee</span> <span>TK:{order.deliveryFee}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span>PlatForm Fee</span> <span>TK:{order.platFromFee}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span>Total</span> <span>TK:{order.totalAmount}</span>
        </div>
